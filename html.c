...
/* %event: onclick, ondblclick, onmousedown, onmouseup,
  ...
  onkeydown, onkeyup */
#define ATTR_EVENTS    ATTR_ONCLICK, ATTR_ONKEYUP, ATTR_ONKEYDOWN, ATTR_ONKEYPRESS, ATTR_ONCHANGE, ATTR_ONINPUT
#define MAXA_EVENTS    6
...
unsigned char ALST_INPUT[] =
    ...
    ATTR_CORE, ATTR_EVENTS, ATTR_ONSELECT, ATTR_CLASS
};
#define MAXA_INPUT      MAXA_CORE + MAXA_EVENTS + 14
unsigned char ALST_BUTTON[] =
    { ATTR_TYPE, ATTR_VALUE, ATTR_NAME, ATTR_CORE, ATTR_ONCLICK, ATTR_CLASS };
#define MAXA_BUTTON	MAXA_CORE + 5
unsigned char ALST_TEXTAREA[] =
    { ATTR_COLS, ATTR_ROWS, ATTR_NAME, ATTR_READONLY, ATTR_CORE,
    ATTR_EVENTS, ATTR_ONSELECT, ATTR_CLASS
};
#define MAXA_TEXTAREA   MAXA_CORE + MAXA_EVENTS + 6
unsigned char ALST_SELECT[] =
    { ATTR_NAME, ATTR_MULTIPLE, ATTR_CORE, ATTR_EVENTS };
#define MAXA_SELECT	MAXA_CORE + MAXA_EVENTS + 2
...
unsigned char ALST_SCRIPT[] =
    { ATTR_LANGUAGE, ATTR_SRC, ATTR_FRAMENAME, ATTR_TYPE, ATTR_CORE };
#define MAXA_SCRIPT	MAXA_CORE + 4
...
unsigned char ALST_FORM_INT[] =
    { ATTR_METHOD, ATTR_ACTION, ATTR_CHARSET, ATTR_ACCEPT_CHARSET,
    ATTR_ENCTYPE, ATTR_TARGET, ATTR_NAME, ATTR_FID, ATTR_ONSUBMIT,
    ATTR_ONRESET, ATTR_CORE,
};
#define MAXA_FORM_INT  MAXA_CORE + 10
unsigned char ALST_INPUT_ALT[] =
    ...
    ATTR_SELECTNUMBER, ATTR_ROWS, ATTR_TOP_MARGIN, ATTR_BOTTOM_MARGIN, ATTR_CLASS
};
#define MAXA_INPUT_ALT  18 + MAXA_EVENTS
...
TagAttrInfo AttrMAP[MAX_TAGATTR] = {
    ...
    {"oninput", VTYPE_STR, 0}, /* 61 ATTR_ONINPUT */
    {"class", VTYPE_STR, 0},		/* 62 ATTR_CLASS */
