...
/* %event: onclick, ondblclick, onmousedown, onmouseup,
  ...
  onkeydown, onkeyup */
#define ATTR_EVENTS    ATTR_ONCLICK, ATTR_ONKEYUP, ATTR_ONKEYDOWN, ATTR_ONKEYPRESS, ATTR_ONCHANGE
#define MAXA_EVENTS    5
...
unsigned char ALST_INPUT[] =
    ...
    ATTR_CORE, ATTR_EVENTS, ATTR_ONSELECT
};
#define MAXA_INPUT      MAXA_CORE + MAXA_EVENTS + 13
unsigned char ALST_BUTTON[] =
    { ATTR_TYPE, ATTR_VALUE, ATTR_NAME, ATTR_CORE, ATTR_ONCLICK };
#define MAXA_BUTTON	MAXA_CORE + 4
unsigned char ALST_TEXTAREA[] =
    { ATTR_COLS, ATTR_ROWS, ATTR_NAME, ATTR_READONLY, ATTR_CORE,
    ATTR_EVENTS, ATTR_ONSELECT
};
#define MAXA_TEXTAREA   MAXA_CORE + MAXA_EVENTS + 5
